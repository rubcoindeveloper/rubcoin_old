...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Rubcoins"));
    case mBTC: return QString(QObject::tr("Milli-Rubcoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Rubcoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
