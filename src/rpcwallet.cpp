...
Value keypoolrefill(const Array& params, bool fHelp)
{
    ...
    unsigned int nSize = max<unsigned int>(GetArgUInt("-keypool", 500), 0);
    if (params.size() > 0) {
...
// Rubcoin: resend unconfirmed wallet transactions
